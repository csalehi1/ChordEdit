...
Paper: selector model T(s) -> (t*, t**). T has no trainable weights; this
script loads a trained surrogate M_hat checkpoint, runs T selection on
held-out samples with full grids, and reports selection metrics
(regret, Spearman on phi, deviate-gate precision/recall).
